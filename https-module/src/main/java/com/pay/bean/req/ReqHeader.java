...
public class ReqHeader {
     ...
     * @param errCode 错误码
     */
    public ReqHeader(String chnlNo, String FTranCode, String instID, String trmSeqNum, String tranDateTime, String errCode) {
        this.ChnlNo = chnlNo;
