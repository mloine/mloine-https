...
/**
 *  @Author: XueYongKang
 *  @Description:    https示例(校验服务端的身份， 即:验证ca)
 *  @Data: 2019/11/19 15:38
 */
public class HttpsCaDemoTest {

    private static final Logger logger = LoggerFactory.getLogger(HttpsCaDemoTest.class);
     ...
     */
    static {
//        InputStream ca = HttpsCaDemoTest.class.getClassLoader().getResourceAsStream("client/ds.crt");
        InputStream ca = HttpsCaDemoTest.class.getClassLoader().getResourceAsStream("client/mloine.crt");
...
//        String url = "https://127.0.0.1:9527/post/test/one";
        String url = "https://127.0.0.1:9527/pay/guangdaPay?key=%E6%88%91%E6%98%AF%E4%B8%BB%E4%BD%93";
